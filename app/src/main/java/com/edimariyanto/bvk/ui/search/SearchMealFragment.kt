...
import com.edimariyanto.bvk.databinding.FragmentSearchMealBinding
...
import com.edimariyanto.bvk.ui.enable
...
class SearchMealFragment : BaseFragment<SearchMealViewModel, FragmentSearchMealBinding, SearchMealRepository>(), RecyclerviewOnClickSearchMeal {
    ...
    private fun initMealAdapter(listData: List<com.edimariyanto.bvk.data.models.meal.search.Meal>) {
    ...
    override fun onItemClick(view: View, meal: com.edimariyanto.bvk.data.models.meal.search.Meal) {
